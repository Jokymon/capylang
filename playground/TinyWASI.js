export class TinyWASI {
    ...
    fd_fdstat_get(fd, fdstat) {
        ...
        view.setUint16(fdstat + 8, this.WASI_RIGHTS_FD_SYNC | this.WASI_RIGHTS_FD_WRITE | this.WASI_RIGHTS_FD_FILESTAT_GET, true);
