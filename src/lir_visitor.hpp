...
namespace lir
{
    ...
    public:
        ...
        void visit(return_statement& value);
        void visit(break_statement& value);
        void visit(expression_statement& value);
        void visit(store_string_statement& value);
        void visit(store_record_statement& value);
        void visit(store_statement& value);
        void visit(while_statement& value);
        void visit(statement& value);
    ...
    protected:
        ...
        virtual void enter(return_statement& value);
        virtual void leave(return_statement& value);
        virtual void enter(break_statement& value);
        virtual void leave(break_statement& value);
        virtual void enter(expression_statement& value);
        virtual void leave(expression_statement& value);
        virtual void enter(store_string_statement& value);
        virtual void leave(store_string_statement& value);
        virtual void enter(store_record_statement& value);
        virtual void leave(store_record_statement& value);
        virtual void enter(store_statement& value);
        virtual void leave(store_statement& value);
        virtual void enter(while_statement& value);
        virtual void leave(while_statement& value);
        ...
        void replace_statement(std::unique_ptr<statement> replacement);
        void replace_statement(statement_list replacements);

    private:
        bool has_expr_replacements_ = false;
        expr_list expr_replacements_;
        expr_list take_expr_replacements();
        bool has_statement_replacements_ = false;
        statement_list statement_replacements_;
        statement_list take_statement_replacements();
    };
