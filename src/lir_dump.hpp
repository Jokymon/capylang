...
namespace lir
{
    ...
    template <class Context>
    void dump(std::ostream& out, Context& ctx, const statement& value, int indent = 0);
    ...
    template <class Context>
    void dump(std::ostream& out, Context& ctx, const return_statement& value, int indent = 0);

    template <class Context>
    void dump(std::ostream& out, Context& ctx, const break_statement& value, int indent = 0);

    template <class Context>
    void dump(std::ostream& out, Context& ctx, const expression_statement& value, int indent = 0);

    template <class Context>
    void dump(std::ostream& out, Context& ctx, const store_string_statement& value, int indent = 0);

    template <class Context>
    void dump(std::ostream& out, Context& ctx, const store_record_statement& value, int indent = 0);

    template <class Context>
    void dump(std::ostream& out, Context& ctx, const store_statement& value, int indent = 0);

    template <class Context>
    void dump(std::ostream& out, Context& ctx, const while_statement& value, int indent = 0);
